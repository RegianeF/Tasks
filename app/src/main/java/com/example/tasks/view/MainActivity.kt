...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupNavigation() {
        ...
        //navControler é quem controla a navegação
        val navController = findNavController(R.id.nav_host_fragment)
        ...
        navView.setNavigationItemSelectedListener {
            //é preciso fazer o Else pq se não o resto da tela para de funcionar
    ...
    private fun observe() {
        ...
        //Pergunta é: Quando fazemos o logout, o que queremos fazer?
        mViewModel.logout.observe(this, Observer {
            startActivity(Intent(this, LoginActivity::class.java))
            finish()
            //É necessário matar a activity
        })
    }
